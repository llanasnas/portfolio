...
export const progressionData: {
    ...
    milestones: [
...

        {
            ...
            dateRange: "2018 – 2020",
            type: "work",
            description: "Gained practical experience building production web software.",
            xp: 800,
...

        {
            ...
            dateRange: "2026",
            type: "project",
            description: "Built a Software-as-a-Service product end-to-end.<br> <a href='https://groupio.llanasdev.com' alt='Groupio' target='_blank' rel='noopener noreferrer'>Groupio</a>",
            xp: 1200,
...

        {
            ...
            dateRange: "2026",
            type: "project",
            description: "Next.js app extracting recipes & macros using AI models.",
            xp: 1300,
